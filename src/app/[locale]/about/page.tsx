...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'About Rise of the Ronin Wiki - Your Ultimate Steam Game Resource',
    description: 'Learn about Rise of the Ronin Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the Rise of the Ronin Steam game.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'About Rise of the Ronin Wiki',
      description: 'Learn about our mission to provide the best Rise of the Ronin game resources and guides.',
      images: [
        {
    ...
    twitter: {
      ...
      title: 'About Rise of the Ronin Wiki',
      description: 'Learn about our mission to provide the best Rise of the Ronin game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            About Rise of the Ronin Wiki
          </h1>
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Rise of the Ronin
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to Rise of the Ronin Wiki</h2>
            <p>
              Rise of the Ronin Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the action RPG "Rise of the Ronin". We are a community-driven platform that provides comprehensive guides,
            ...
            <p>
              ...
              Rise of the Ronin Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Rise of the Ronin players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Rise of the Ronin Wiki as the <strong>go-to destination</strong> for every Rise of the Ronin player seeking
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Rise of the Ronin Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Rise of the Ronin Wiki is maintained by a dedicated team of passionate gamers and developers who love
              Rise of the Ronin as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Rise of the Ronin mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>Rise of the Ronin Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with the developers of Rise of the Ronin or any official entities.
            </p>
            <p>
            ...
            <p>
              Rise of the Ronin Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@riseoftheronin.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@riseoftheronin.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@riseoftheronin.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@riseoftheronin.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@riseoftheronin.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@riseoftheronin.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@riseoftheronin.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@riseoftheronin.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and Rise of the Ronin news.
